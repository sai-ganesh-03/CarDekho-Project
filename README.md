...
> **Note for reviewers:** Every API call has a deliberate 10-second delay due to Gemini free-tier rate limits, responses will feel slow, this is expected. It also has a limit of 20 API calls per day. If you are not getting any response from chatbot, it may be because of the rate limts. Also, the first ~20 minutes of the demo recording was lost due to a system crash.
